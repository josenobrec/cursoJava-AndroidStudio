...
public class PostagemAdapter extends RecyclerView.Adapter<PostagemAdapter.MyViewHolder> {
    ...
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) { // Layout para exibir o Card View
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) { // Construtor para o ViewHolder
            super(itemView);
            textNome = itemView.findViewById(R.id.texNome);
