package com.cursoandroid.youtubeapp;
...
public class MainActivity extends YouTubeBaseActivity
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyDDSSuYCMuQMxhBaffqlPrUETR7umbseSA";
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean foiRestaurado) {
        ...
        Toast.makeText(this,
                "Sucesso ao inciar o Player!",
                Toast.LENGTH_SHORT).show();

        //youTubePlayer.loadVideo("qRXkEQOtQ98"); // inicia automaticamente o video
        ...
        if(!foiRestaurado) { // continuar o video de onde parou
            //youTubePlayer.cueVideo("qRXkEQOtQ98"); // Carrega o video pronto para executar, mas não executa
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        Toast.makeText(this,
                "Erro ao inciar o Player!" + youTubeInitializationResult.toString(),
                Toast.LENGTH_SHORT).show();
    }
}
